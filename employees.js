...
class Manager extends Employee {
    constructor(name, shifts, employees) {
        ...
        this.addEmployees = this.addEmployees;
    }

    getEmployees() {
        console.log(`${this.name} manages:${this.employees.reduce((list, emp) => list.push(emp.name), []).split(", ")}.`);
    }
...
const empCece = new Employee('Cece', 'weekday mornings, weekday afternoons');
const empSchmidt = new Employee('Schmidt', 'weekday mornings, weekday afternoons');

const manager = new Manager('Winston', 'weekday mornings, weekday afternoons', [empCece, empSchmidt]);
...
//CODE HERE 
manager.addEmployees(new Employee ('Coach', 'weekday mornings, weekday afternoons'));
/*
    Call the `getEmployees` method on the
